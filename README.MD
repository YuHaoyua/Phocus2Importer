...
### 推荐：直接下载
请前往本项目的 [**Releases**](https://github.com/YuHaoyua/Phocus2Importer/releases/tag/v1.0.0) 页面下载最新编译好的二进制文件。解压后即可在终端中使用。
...
1.  **安装 App**：你的 Mac 必须已安装 Phocus Mobile 2。
    ...
    *   *方式 B*：直接从 Mac App Store 下载官方 iPad 版本。
...
```
然后前往 系统设置 → 隐私与安全性，在“允许以下来源的应用程序”选择 任何来源。
